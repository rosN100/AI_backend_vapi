-- Clean complete setup for user permissions and admin user
-- This handles existing triggers and tables gracefully

-- Create or recreate the user_profiles table with a better structure
